...
function _addIssue(context, label, dataset, config2, other) {
  ...
  const message2 = (other == null ? void 0 : other.message) ?? context.message ?? getSpecificMessage(context.reference, issue.lang) ?? (isSchema ? getSchemaMessage(issue.lang) : null) ?? config2.message ?? getGlobalMessage(issue.lang);
  if (message2 !== void 0) {
    ...
    "~run"(dataset, config3) {
      ...
      try {
        const output = JSON.stringify(
          dataset.value,
          // @ts-expect-error
          (_a = this.config) == null ? void 0 : _a.replacer,
          (_b = this.config) == null ? void 0 : _b.space
        );
        if (output === void 0) {
          _addIssue(this, "JSON", dataset, config3);
          dataset.typed = false;
